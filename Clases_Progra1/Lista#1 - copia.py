...
for num in listA:
    if(num % 2 == 0):
        par.append(num)
print("Los numeros pares de la lista A son:\n",par)

#Imprimir de la listB los números divisibles de 3 y los sume
...
for numB in listB:
    if numB % 3 == 0:
        divB.append(numB)
print()
print("Los números divisibles entre 3 de la lista B son:\n",divB,"La suma de estos números sería:",sum(divB))

#Imprimir de la listC los números divisibles de 10 y los multiplique
import math
divC = []
...
for numC in listC:
    if numC % 10 == 0:
        divC.append(numC)
        print()
        print("Los números divisibles entre 10 de la lista C son:\n",divC,"La multiplicación de los números sería:\n",math.prod(divC))

#Imprimir de la listD los números mayores a 15 y les saque el promedio.
new = []
for elem in listD:
    if elem >= 15:
        new.append(elem)
print()
print("Los números mayores a 15 de la lista D son:\n",new,"\nY el promedio es:\n",sum(new)/len(new))

#Imprimir de la listE los números divisibles de 6 
...
for nume in listE:
    if nume % 6 == 0:
        divE.append(nume)
print()
print("Los números divisibles entre 6 de la lista E son:\n",divE)

#Imprimir de la listF los números impares 
...
for F in listF:
    if F % 2 != 0:
        impar.append(F)
print()
print("Los números impares de la lista F son:\n",impar)
