...
while (seguir != 'n' and seguir != 'N'):
    ...
    match(opc):
        case 1:
            while len(temp) < 15:
                num = int(input("Introduce las temperaturas de cada hora durante el día: "))
                if num <= 40:
                    temp.append(num)
                else:
        ...
        case 2:
            ...
            seguir = str(input("Digite S si desea volver al menú\nDigite N si desea salir\n"))
        case 3:
            print("Las temperaturas en Grados centígrados recolectadas cada hora fueron: \n")
            for t in temp:
                print(f"{t}°")

            seguir = str(input("Digite S si desea volver al menú\nDigite N si desea salir\n"))
        case 4:
            print("La temperatura mal alta alcanzada el dia de hoy fueron:\n",max(temp),"°")
            print("La temperatura mas baja alcanzada el dia de hoy fueron:\n",min(temp),"°")
            seguir = str(input("Digite S si desea volver al menú\nDigite N si desea salir\n"))
